  ...
  const handlePrintReport = () => {
    try {
      ...
      const printContent = `
        <html>
          <head>
            <title>Expiring Products Report</title>
            <style>
              @media print {
          ...
          <body>
            <div class="header">
              <h1>Expiring Products Report</h1>
      ...
      toast({
        title: "Success",
        description: "Expiring products report sent to printer",
      });
    } catch (error) {
      toast({
        title: "Error",
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-2xl font-bold">{(totalExpiring / (inventory.length || 1) * 100).toFixed(1)}%</div>
                <p className="text-xs text-muted-foreground">
